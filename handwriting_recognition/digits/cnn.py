...
model = train_cnn_model(mnist_training, epochs, batch_size, lr)

# Validate the model by making predictions
train_predictions, train_acc, train_loss = validate_cnn_model(mnist_training)
val_predictions, val_acc, val_loss = validate_cnn_model(mnist_val)
