...
mnist_training = datasets.FashionMNIST(root='/tmp/mnist', train=True, download=True, transform=t)
mnist_val = datasets.FashionMNIST(root='/tmp/mnist', train=False, download=True, transform=t)
